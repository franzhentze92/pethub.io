-- RLS Policy for Admin to view all exercise_sessions
-- This allows the admin user (admin@pethubgt.com) to see all exercise sessions

-- First, ensure RLS is enabled on exercise_sessions
...
DROP POLICY IF EXISTS "Admin can view all exercise sessions" ON public.exercise_sessions;

-- Create policy to allow admin to view all exercise sessions
CREATE POLICY "Admin can view all exercise sessions"
